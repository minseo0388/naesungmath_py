...
class Solid3D:
    ...
    def cone_area(radius=None, height=None):
        ...
        raise ValueError("Insufficient parameters for cone_area.")
    ...
    def cone_volume(radius=None, height=None):
        ...
        raise ValueError("Insufficient parameters for cone_volume.")
    ...
    def cylinder_area(radius=None, height=None):
        ...
        raise ValueError("Insufficient parameters for cylinder_area.")

    @staticmethod
    def cylinder_volume(radius=None, height=None):
        if radius is not None and height is not None:
            return math.pi * (radius**2) * height
        raise ValueError("Insufficient parameters for cylinder_volume.")
    ...
    def square_pyramid_area(base_side=None, height=None, slant_edge=None):
        ...
        raise ValueError("Insufficient parameters for square_pyramid_area.")
    ...
    def square_pyramid_height(base_side=None, slant_edge=None):
        ...
        raise ValueError("Insufficient parameters for square_pyramid_height.")
    ...
    def square_pyramid_volume(base_side=None, height=None, slant_edge=None):
        ...
        raise ValueError("Insufficient parameters for square_pyramid_volume.")
    ...
    def triangular_pyramid_volume(base_area=None, height=None):
        ...
        raise ValueError("Insufficient parameters for triangular_pyramid_volume.")
